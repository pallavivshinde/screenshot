...
class Test_005_mul_window():
    ...
    def test_005_mul_window_tab(self):
        ...
        parenttext2 = driver.find_element(By.XPATH,
        ...
        for w in select_window2:
            ...
            if (driver.title == 'NxtGen A.I Academy – Automate Intelligently'):
                ...
                print('\n***********CHILD WINDOW TEXT*********');
                childtext3 = driver.find_element(By.XPATH,
                                                 '(//h2[@class="elementor-heading-title elementor-size-default"])[1]').text;
                print(childtext3);
        ...
        parenttext3 = driver.find_element(By.XPATH,
                                          '//h1[@class="elementor-heading-title elementor-size-default"]').text;
        print('\n**********PARENT WINDOW TEXT*********');
        print(parenttext3);
